...
```bash
└─$ nmap -n -sV --script "ldap* and not brute" 10.129.251.212
Starting Nmap 7.92 ( https://nmap.org ) at 2022-11-19 17:14 EST
...
88/tcp   open  kerberos-sec  Microsoft Windows Kerberos (server time: 2022-11-20 05:15:08Z)
...
|       currentTime: 20221120051514.0Z
|_      configurationNamingContext: CN=Configuration,DC=streamIO,DC=htb
